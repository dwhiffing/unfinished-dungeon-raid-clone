(function(exports) {
            ...
            for (var i in pieces) {
                ...
                if (checked.indexOf(piece) === -1) {
                    ...
                    if (match.length >= 3) {
                        ...
                        if (piece.o.type !== voidObject.type) {
                            matches.push(match);
                        }
    ...
    Grid.prototype.swapPieces = function(piece1, piece2) {
        ...
        piece1.o = tmp2;
        piece2.o = tmp1;
        piece1.o.gridX = piece1.x
        piece1.o.gridY = piece1.y
        piece2.o.gridX = piece2.x
        piece2.o.gridY = piece2.y
    }
            ...
            for (var i = 0; i < (horizontal ? this.height : this.width); i++) {
                ...
                function applyGravity(grid) {
                    ...
                    for (var p in chunk) {
                        ...
                        if (piece.o.type !== -1 && neighbour && neighbour.o.type === -1) {
    ...
    Piece.prototype.matchingNeighbours = function() {
        ...
        for (var direction in neighbours) {
            ...
            if (neighbour && neighbour.o.type === this.o.type) {
