(function(exports) {
    ...
    Grid.prototype.swapPieces = function(piece1, piece2) {
        ...
        piece1.object = tmp2;
        piece2.object = tmp1;
        piece1.object.gridX = piece1.x
        piece1.object.gridY = piece1.y
        piece2.object.gridX = piece2.x
        piece2.object.gridY = piece2.y
    }
            ...
            for (var i = 0; i < (horizontal ? this.height : this.width); i++) {
                ...
                function applyGravity(grid) {
                    ...
                    for (var p in chunk) {
                        ...
                        if (piece.object.type !== -1 && neighbour && neighbour.object.type === -1) {
