  ...
  Update: function () {
    for (var y = 0; y < Dungeon.map_size; y++) {
      for (var x = 0; x < Dungeon.map_size; x++) {
        ...
        if (tile == 0) _.miniMap.beginFill('#351330');
        else if (tile == 1) _.miniMap.beginFill('#64908A');
        else _.miniMap.beginFill('#424254');
        _.miniMap.drawRect(x * this.scale, y * this.scale, this.scale, this.scale);
      }
    }
  }
};
